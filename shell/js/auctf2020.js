...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "CTF : AUCTF2020\nDate: 03-04-2020 -> 06-04-2020",
...
var folders = (function () {
    ...
    SingletonFolders.defaultOptions = {
        "/": "index.html",
        "..": "writeups.html",
        "bash": "AUCTF2020/bash.html",
        "crypto": "AUCTF2020/crypto.html",
        "forensic": "AUCTF2020/forensic.html",
        "passwordcracking": "AUCTF2020/psswdcracking.html",
        "pwn": "AUCTF2020/pwn.html",
        "reverse":"AUCTF2020/reverse.html",
        "signal": "AUCTF2020/signal.html",
        "web": "AUCTF2020/web.html"
    };
    return{
        getInstance: function(options){
...
var main = (function () {
    ...
    var Terminal = function (prompt, cmdLine, output, sidenav, profilePic, user, host, root, outputTimer) {
        ...
        (typeof user === "string" && typeof host === "string") && (this.completePrompt = user + "@" + host + ":~/writeups/auctf2020/" + (root ? "#" : "$"));
    ...
    Terminal.prototype.cat = function (cmdComponents) {
        var result = "Cat command is unvailable in this context.";
        this.type(result, this.unlock.bind(this));
    };
