...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "Welcome to my writeups!\n Pick one CTF to see all writeups that i've writen!\n Use the same commands as before.",
...
var folders = (function () {
    ...
    SingletonFolders.defaultOptions = {
        "/": "index.html",
        "..": "index.html",
        "auctf2020" : "auctf2020.html",
        "tghack2020" : "tghack2020.html",
        "fcsc2020" : "fcsc2020.html"
    };
    return{
        getInstance: function(options){
...
var main = (function () {
    ...
    var Terminal = function (prompt, cmdLine, output, sidenav, profilePic, user, host, root, outputTimer) {
        ...
        (typeof user === "string" && typeof host === "string") && (this.completePrompt = user + "@" + host + ":~/writeups/" + (root ? "#" : "$"));
