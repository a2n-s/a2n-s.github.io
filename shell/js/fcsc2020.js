...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "CTF : FCSC2020\nDate: 24-04-2020 -> 04-05-2020",
...
var folders = (function () {
    ...
    SingletonFolders.defaultOptions = {
        "/": "index.html",
        "..": "writeups.html",
       "forensic": "FCSC2020/forensic.html",
       "misc": "FCSC2020/misc.html",
       "pwn":"FCSC2020/pwn.html",
       "web": "FCSC2020/web.html"
    };
    return{
        getInstance: function(options){
...
var main = (function () {
    ...
    var Terminal = function (prompt, cmdLine, output, sidenav, profilePic, user, host, root, outputTimer) {
        ...
        (typeof user === "string" && typeof host === "string") && (this.completePrompt = user + "@" + host + ":~/writeups/fcsc2020/" + (root ? "#" : "$"));
